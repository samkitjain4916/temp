...
const Agencyapplyform = () => {
    ...
    const api=(data)=>{
        return fetch("http://localhost:5000/agencyapplyform",{
            method:"POST",
            body:data
        }).then(function(text) {                          
    ...
    return (
        <div className='container'>
            <div class="card-header">
                <h1>Agency Registration / Apply Form</h1>
            </div>
            <div class="card-body">
                <form onSubmit={(e)=>e.preventDefault()}>
                    ...
                    <div class="form-group row">
                        <label for="full_name" class="col-md-4 col-form-label text-md-right">Agency Name*</label>
                        <div class="col-md-6">
                            <input type="text" onChange={onHandleChange('name')} placeholder="Name" class="form-control" />
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="phone_number" class="col-md-4 col-form-label text-md-right">Upload Documents*</label>
                        <div class="col-md-6">
                            <input type="file" onChange={onHandleChange('photo')} class="form-control"/>
                        </div>
                    </div>

                    <div class="form-group row">
                        <button type="submit" class="btn btn-primary" onClick={()=>api(formData)}>
                            Apply
                        </button>
                    </div>
